...
class ButtonScreenshotTest {
  ...
  @Test
  fun pressed() = assertScreenshot("button-pressed", width = 760, height = 360) {
    DittoPreviewMatrix {
  ...
  @Composable
  private fun pressedSource(): MutableInteractionSource = MutableInteractionSource().also {
    it.tryEmit(PressInteraction.Press(Offset.Zero))
  }
}
